    ...
    class o {
        ...
        findMatchingRoute({url: t, sameOrigin: e, request: s, event: n}) {
            ...
            for (const r of i) {
                ...
                if (o)
                    return i = o,
                    (Array.isArray(i) && 0 === i.length || o.constructor === Object && 0 === Object.keys(o).length || "boolean" == typeof o) && (i = void 0),
                    {
                        route: r,
                        params: i
                    }
    ...
    class E extends C {
        ...
        k() {
            ...
            for (const [s,n] of this.plugins.entries())
                n !== E.copyRedirectedCacheableResponsesPlugin && (n === E.defaultPrecacheCacheabilityPlugin && (t = s),
                n.cacheWillUpdate && e++);
